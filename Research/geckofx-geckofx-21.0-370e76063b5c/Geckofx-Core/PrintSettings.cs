...
namespace Gecko
{
        ...
        [ComVisible(true)]
        [ContractID(PrintPromptingSericeFactory.ContractID)]
        [Guid("65C1D9B6-1F47-4C94-A04F-146C18F6FD68")]
        public class PrintPromptingSericeFactory :
            GenericOneClassNsFactory<PrintPromptingSericeFactory, PrintPromptingService>
        {
            public const string ContractID = "@mozilla.org/embedcomp/printingprompt-service;1";
        }

        [ComVisible(true)]
        public class PrintPromptingService : nsIPrintingPromptService, nsIWebProgressListener
        {
            ...
            public void ShowPrinterProperties(nsIDOMWindow parent, string printerName, nsIPrintSettings printSettings)
            {
                throw new NotImplementedException();
            }
